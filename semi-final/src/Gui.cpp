...
void DrawTile(App& app, const sf::Vector2f& pos, Field tile, int color_id=0) {
	...
	std::vector<sf::Color> colors {
		sf::Color(0xff, 0xff, 0xcc),
		sf::Color(0xff, 0xed, 0xa0),
		sf::Color(0xfe, 0xd9, 0x76),
		sf::Color(0xfe, 0xb2, 0x4c),
		sf::Color(0xfd, 0x8d, 0x3c),
		sf::Color(0xfc, 0x4e, 0x2a),
		sf::Color(0xe3, 0x1a, 0x1c),
		sf::Color(0xbd, 0x00, 0x26),
		sf::Color(0x80, 0x00, 0x26),
		sf::Color(0xff, 0xff, 0x00),
		sf::Color(0xff, 0xed, 0x00),
		sf::Color(0xfe, 0xd9, 0x00),
		sf::Color(0xfe, 0xb2, 0x00),
		sf::Color(0xfd, 0x8d, 0x00),
		sf::Color(0xfc, 0x4e, 0x00),
		sf::Color(0xe3, 0x1a, 0x00),
		sf::Color(0xbd, 0x00, 0x00),
		sf::Color(0x80, 0x00, 0x00),
		sf::Color(0xff, 0x00, 0xcc),
		sf::Color(0xff, 0x00, 0xa0),
		sf::Color(0xfe, 0x00, 0x76),
		sf::Color(0xfe, 0x00, 0x4c),
		sf::Color(0xfd, 0x00, 0x3c),
		sf::Color(0xfc, 0x00, 0x2a),
		sf::Color(0xe3, 0x00, 0x1c),
		sf::Color(0xbd, 0x00, 0x26),
		sf::Color(0x80, 0x00, 0x26),
	};
